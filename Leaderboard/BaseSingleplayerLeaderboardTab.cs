...
public abstract class BaseSingleplayerLeaderboardTab<TItem> : BaseSingleplayerLeaderboardTab
{
    ...
    protected TItem this[int index] => _items[index];

    protected TItem ElementAt(int index)
    {
        return _items[index];
    }
