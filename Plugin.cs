...
public class Plugin : BaseUnityPlugin
{
    ...
    private void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddEagerService<GhostSpectateService>();
        services.AddEagerService<GhostSpectateInputDisplayService>();
        ...
        services.AddSingleton<GhostSpectateState>();
        services.AddSingleton<GhostSpectateDrawer>();
        services.AddEagerService<GhostSpectateUiService>();
