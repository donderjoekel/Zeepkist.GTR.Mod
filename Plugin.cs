...
using TNRD.Zeepkist.GTR.UI.Tournaments;
...
public class Plugin : BaseUnityPlugin
{
    ...
    private void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<TournamentsWindowState>();
        services.AddSingleton<TournamentGraphqlService>();
        services.AddSingleton<TournamentsDrawer>();
        services.AddSingleton<TournamentJoinLoadingDrawer>();
        services.AddEagerService<TournamentsMenuButtonService>();
        services.AddEagerService<TournamentsUiService>();
        services.AddEagerService<TournamentJoinOrchestrator>();
